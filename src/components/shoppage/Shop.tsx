...
function Shop() {
  ...
  const products = [
    { id: 1, name: 'Navy Jersey', image: Image1, category: 'Men', subcategory: "Men's Jackets" },
    { id: 2, name: 'Graphic T-Shirt', image: Image2, category: 'Men', subcategory: 'Half Zip Sweatshirts' },
    { id: 3, name: 'Striped Sweater', image: Image3, category: 'Men', subcategory: 'Half Zip Sweatshirts' },
    { id: 4, name: 'Knitted Cardigan', image: Image4, category: 'Women', subcategory: 'Half Zip Sweatshirts' },
    { id: 5, name: "Men's Corduroy Shirt", image: Image5, category: 'Men', subcategory: 'Half Zip Sweatshirts' },
    { id: 6, name: 'Cargo Pants', image: Image6, category: 'Men', subcategory: 'Baggy Pants' },
    { id: 7, name: 'Linen Shorts', image: Image7, category: 'Men', subcategory: 'Baggy Pants' },
    { id: 8, name: 'Metal Pendant', image: Image8, category: 'Accessories' },
    { id: 9, name: 'Aesthetic Sunglasses', image: Image9, category: 'Accessories', subcategory: 'Aesthetic Sunglasses' },
    { id: 10, name: 'Baseball Cap', image: Image10, category: 'Accessories', subcategory: 'Trendy Caps' },
    { id: 11, name: 'Oversized Hoodie', image: Image11, category: 'Women', subcategory: 'Kids Apparel' },
    { id: 12, name: 'Summer Sundress', image: Image12, category: 'Women', subcategory: 'Sundress' },
    { id: 13, name: 'Trendy Sneakers', image: Image13, category: 'Kids', subcategory: 'Kids Apparel' },
    ...
    <Layout>
      <div className="shop-container">
        ...
        <nav className="sub-categories">
          <ul>
            <li 
              className={selectedSubCategory === "Men's Jackets" ? 'active' : ''}
              onClick={() => selectSubCategory("Men's Jackets")}
            >
              Men's Jackets
            </li>
            <li 
              className={selectedSubCategory === 'Half Zip Sweatshirts' ? 'active' : ''}
            ...
            <li 
              className={selectedSubCategory === 'Aesthetic Sunglasses' ? 'active' : ''}
        ...
        <div className="promo-section">
          <button className="promo-button" onClick={togglePromos}>
